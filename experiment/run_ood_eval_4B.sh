...
# Scenario 1: Model trained on GSM8K, evaluated on MMLU (OOD)
echo "=== Example 1: SQUADv2 → GSM8k (DoRA) ==="
CUDA_VISIBLE_DEVICES=7 python run_shadow_peft_ood_eval.py \
  --mode dora \
  --trained_on squad_v2 \
  --task gsm8k \
  --model_name Qwen/Qwen3-4B \
  --checkpoint_dir erin99/Qwen3-4B-SquadV2-DoRA \
  --gsm8k_subset main \
  --k_shot 2 \
  --max_seq_length 1024 \
  --generation_max_length 512 \
  --per_device_eval_batch_size 16 \
  --bf16 1 \
  --output_dir ./ood_eval/squad_v2_to_gsm8k_dora \
  --seed 42

# Scenario 2: GSM8k -> SquadV2
echo "=== Example 2: SQuAD v2 -> MMLU (DoRA) ==="
CUDA_VISIBLE_DEVICES=7 python run_shadow_peft_ood_eval.py \
  --mode dora \
  --trained_on squad_v2 \
  --task mmlu \
  ...
  --per_device_eval_batch_size 16 \
  --bf16 1 \
  --output_dir ./ood_eval/squad_v2_to_mmlu_dora \
  --seed 42
...
# Scenario 1: Model trained on GSM8K, evaluated on MMLU (OOD)
echo "=== Example 1: MMLU → GSM8k (ShadowPEFT) ==="
CUDA_VISIBLE_DEVICES=7 python run_shadow_peft_ood_eval.py \
  --mode shadow \
  --trained_on mmlu \
  --task gsm8k \
  ...
  --per_device_eval_batch_size 16 \
  --bf16 1 \
  --output_dir ./ood_eval/mmlu_to_gsm8k_shadow \
  --seed 42

# Scenario 2: GSM8k -> SquadV2
echo "=== Example 2: MMLU -> SQuAD v2 ==="
CUDA_VISIBLE_DEVICES=2 python run_shadow_peft_ood_eval.py \
  --mode shadow \
  --trained_on mmlu \
  --task squad_v2 \
  --squad_answer_mode final \
  ...
  --per_device_eval_batch_size 16 \
  --bf16 1 \
  --output_dir ./ood_eval/mmlu_to_squad_v2_shadow \
  --seed 42



# Scenario 1: Model trained on GSM8K, evaluated on MMLU (OOD)
echo "=== Example 1: MMLU → GSM8k (LoRA) ==="
CUDA_VISIBLE_DEVICES=3 python run_shadow_peft_ood_eval.py \
  --mode lora \
  --trained_on mmlu \
  --task gsm8k \
  --model_name Qwen/Qwen3-4B \
  --checkpoint_dir erin99/Qwen3-4B-MMLU-LoRA \
  --gsm8k_subset main \
  --k_shot 2 \
  --max_seq_length 1024 \
  --generation_max_length 512 \
  --per_device_eval_batch_size 16 \
  --bf16 1 \
  --output_dir ./ood_eval/mmlu_to_gsm8k_lora \
  --seed 42

# Scenario 2: GSM8k -> SquadV2
echo "=== Example 2: MMLU -> SQuAD v2 (LoRA) ==="
CUDA_VISIBLE_DEVICES=2 python run_shadow_peft_ood_eval.py \
  --mode lora \
  --trained_on mmlu \
  --task squad_v2 \
  ...
  --per_device_eval_batch_size 16 \
  --bf16 1 \
  --output_dir ./ood_eval/mmlu_to_squad_v2_lora \
  --seed 42



# Scenario 1: Model trained on GSM8K, evaluated on MMLU (OOD)
echo "=== Example 1: MMLU → GSM8k (DoRA) ==="
CUDA_VISIBLE_DEVICES=3 python run_shadow_peft_ood_eval.py \
  --mode dora \
  --trained_on mmlu \
  --task gsm8k \
  --model_name Qwen/Qwen3-4B \
  --checkpoint_dir erin99/Qwen3-4B-MMLU-DoRA \
  --gsm8k_subset main \
  --k_shot 2 \
  --max_seq_length 1024 \
  --generation_max_length 512 \
  --per_device_eval_batch_size 16 \
  --bf16 1 \
  --output_dir ./ood_eval/mmlu_to_gsm8k_dora \
  --seed 42

# Scenario 2: GSM8k -> SquadV2
echo "=== Example 2: MMLU -> SQuAD v2 (DoRA) ==="
CUDA_VISIBLE_DEVICES=7 python run_shadow_peft_ood_eval.py \
  --mode dora \
  --trained_on mmlu \
  --task squad_v2 \
  ...
  --per_device_eval_batch_size 16 \
  --bf16 1 \
  --output_dir ./ood_eval/mmlu_to_squad_v2_dora \
  --seed 42